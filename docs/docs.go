...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/departments/managed-for-filter": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.ManagedDepartmentResponse"
                            }
                        }
                    },
                    "401": {
        ...
        "/departments/{id}/members-for-filter": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/dto.DepartmentMemberForFilterResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/tasks": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "部门ID（筛选该部门成员创建或执行的任务）",
                        "name": "department_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "成员用户ID（筛选指定成员创建或执行的任务，可配合department_id使用）",
                        "name": "member_id",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "时间范围快捷筛选：week(近一周)/month(近一个月)/three_months(近三个月)",
                        "name": "time_range",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "自定义开始时间（格式：2006-01-02 或 2006-01-02T15:04:05）",
                        "name": "start_time",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "自定义结束时间（格式：2006-01-02 或 2006-01-02T15:04:05）",
                        "name": "end_time",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "dto.DepartmentMemberForFilterResponse": {
            "type": "object",
            "properties": {
                "is_leader": {
